...
public abstract class JdbcTest {
    ...
    public void test000testDriver() throws SQLException {
        ...
        Assert.assertEquals(Driver.CACHE_DRIVER_URL, infos[0].name);
        Assert.assertEquals(Driver.CACHE_DRIVER_CLASS, infos[1].name);
        Assert.assertEquals(Driver.CACHE_DRIVER_ACTIVE, infos[2].name);
    }
