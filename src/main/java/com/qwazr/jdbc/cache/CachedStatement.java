...
class CachedStatement<T extends Statement> implements Statement {
    ...
    protected final ResultSetCacheImpl resultSetCache;
    ...
    protected volatile String generatedKey;
    ...
    public boolean execute(String sql) throws SQLException {
        ...
        if (resultSetCache.checkIfExists(generatedKey))
            return true;
        return checkBackendStatement("No cache entry").execute(sql);
    }
    ...
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        ...
        if (resultSetCache.checkIfExists(generatedKey))
            return true;
        return checkBackendStatement("No cache entry").execute(sql, autoGeneratedKeys);
    }
    ...
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        ...
        if (resultSetCache.checkIfExists(generatedKey))
            return true;
        return checkBackendStatement("No cache entry").execute(sql, columnIndexes);
    }
    ...
    public boolean execute(String sql, String[] columnNames) throws SQLException {
        ...
        if (resultSetCache.checkIfExists(generatedKey))
            return true;
        return checkBackendStatement("No cache entry").execute(sql, columnNames);
    }
