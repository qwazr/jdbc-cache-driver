...
class CachedConnection(private val connection: Connection?, val resultSetCache: ResultSetCache?) : Connection {
    ...
    override fun createStatement(): Statement {
        ...
        return if (resultSetCache != null) CachedStatement(this, resultSetCache, statement) else statement!!
    }

    @Throws(SQLException::class)
    override fun prepareStatement(sql: String): PreparedStatement {
        val statement = connection?.prepareStatement(sql)
        return if (resultSetCache != null) CachedPreparedStatement(
            this,
            resultSetCache,
            statement,
            sql
    ...
    override fun prepareCall(sql: String): CallableStatement {
        ...
        return if (resultSetCache != null) CachedCallableStatement(
            this,
            resultSetCache,
            statement,
            sql
    ...
    override fun createStatement(resultSetType: Int, resultSetConcurrency: Int): Statement {
        ...
        return if (resultSetCache != null) CachedStatement(
            this,
            resultSetCache,
            statement,
            resultSetType,
